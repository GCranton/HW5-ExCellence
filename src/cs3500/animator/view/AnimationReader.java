...
public class AnimationReader {
   ...
   * @return
   */
  public static <Doc> IAnimator parseFile(Readable readable, AnimationBuilder<IAnimator> builder) {
  ...
  private static <Doc> void readCanvas(Scanner s, AnimationBuilder<IAnimator> builder) {
    int[] vals = new int[4];
  ...
  private static <Doc> void readShape(Scanner s, AnimationBuilder<IAnimator> builder) {
    String name;
    String type;
    if (s.hasNext()) {
      name = s.next();
